...
$providerQuery = "SELECT name, email FROM home_maintenance_service_providers WHERE email = ?";
...
$sql = "INSERT INTO home_quote_requests (provider_name, name, email, phone, service_date, additional_info)
        VALUES (?, ?, ?, ?, ?, ?)";
...
if ($stmt->execute()) {
    ...
    function sendEmail($recipient, $recipientName, $subject, $body) {
        ...
        try {
            ...
            $mail->setFrom('projectafraaz@gmail.com', 'HOMIFY SERVICES');
